...
function Home() {
  ...
  return (
    <div className="relative w-full min-h-screen flex items-start justify-center font-sans overflow-hidden pt-0 px-4 pb-4 md:pb-0">
      ...
      >
        {/* Signature Text */}
        <div className="absolute top-4 left-4 md:top-4 md:right-4 md:left-auto z-20 max-w-[80%] md:max-w-none">
        ...
        {/* Left Content */}
        <div className="flex flex-col justify-start w-full md:w-1/2 space-y-4 md:space-y-2 mt-16 md:mt-6">
        ...
        {/* Right Image */}
        <div className="relative w-full md:w-1/2 h-48 md:h-auto flex items-end justify-center overflow-hidden">
          <img
            src={futureImage}
